...
for(i in 1:1) {
  ...
  nbinlogStanFit <- stan("~/diffExpModel/PhDBayesianWork/code/negativeBinomialModel/nbinModel.stan",data = stanDataCurrent,iter = 1000, chains = 4)
...
negBinSampleaWild <- negBinPosteriorSample$scaleFactors
